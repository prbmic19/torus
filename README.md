...
The kernel sets up a minimal serial-backed console, basic interrupt handling, and a PIT-based timer tick. It then draws a test pattern on the framebuffer before entering an idle loop.
